...
import { withWalletKey, isMantleAgentClass } from "./tools/helper";
...
export const createTools = (agent: MantleAgentInterface) => [
  ...
  tool(getBlockNumber, {
    ...
    description: "Get the current block number from the Mantle network",
  }),
  ...
  tool(getSpecVersion, {
    ...
    description: "Get the current spec version from the Mantle RPC provider",
  }),
  ...
  tool(getBlockLatestAccepted, {
    ...
    description:
      "Retrieve the latest accepted block's hash and number from the Mantle network.",
  }),
  tool(getChainId, {
    name: "get_chain_id",
    description:
      "Retrieve the unique identifier (chain ID) of the Mantle network.",
  }),
  tool(getSyncingStats, {
    name: "get_syncing_status",
    description:
      "Retrieve the syncing status of the Mantle node, including the current block, highest block, and starting block if syncing.",
  }),
  ...
  tool(withWalletKey(declareContract, agent), {
    ...
    description: "Declare a new contract on Mantle",
